...
def weather_dialog():
    try:
        ...
        if len(locations) == 0:
            ...
            # in cases there are 2 locations with similar names for example, try location mou, it will suggest you
            # possible locations like Plymouth, Falmouth, Mountain View
