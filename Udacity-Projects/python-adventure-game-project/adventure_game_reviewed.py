...
# default value of pause=2
def print_pause(string, pause=2):
    print(string)
    #time.sleep(pause)
...
def intro(name, items):
    ...
    # multiline strings in python at https://www.techbeamers.com/python-multiline-string/
...
# a sleek trick to make this script more robust
if __name__ == "__main__":
    play_game()
# What this does is only make this function call ( play_game() ) if you run the script from terminal like ( python
# adventure_game.py ). The __name__ variable's value depends on how you use the script ( adventure_game.py ) in this
# case, if you import this adventure_game.py script in some other python file the play_game() function will be
# invoked ( called ) automatically, but if done as suggested this function will only be invoked when the script is
# run from terminal ( python adventure_game.py ). You can learn more about this in the following link
